...
api_key = ''
web3_provider = Web3.HTTPProvider(f'https://eth-mainnet.g.alchemy.com/v2/{api_key}')
async_web3_provider = Web3.AsyncHTTPProvider(f'https://eth-mainnet.g.alchemy.com/v2/{api_key}')
